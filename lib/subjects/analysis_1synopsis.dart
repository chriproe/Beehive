...
class Analysi_1SynopsisWidget extends StatefulWidget {
  const Analysi_1SynopsisWidget({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Analysi_1SynopsisWidgetState();
  }

class _Analysi_1SynopsisWidgetState extends State<Analysi_1SynopsisWidget> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.deepOrange[800],
          title: const Text('Σύνοψη - Ανάλυση Ι'),
          actions: [
            IconButton(
              onPressed: () {
