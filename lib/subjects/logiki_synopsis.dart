...
class LogikiSynopsisWidget extends StatefulWidget {
  const LogikiSynopsisWidget({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _LogikiSynopsisWidgetState();
  }

class _LogikiSynopsisWidgetState extends State<LogikiSynopsisWidget> {
  @override
